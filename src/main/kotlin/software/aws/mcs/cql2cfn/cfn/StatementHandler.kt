...
abstract class StatementHandler<T : Statement> {
    fun handle(generator: CfnTemplateGenerator, statement: T): Unit =
        generator.run {
            Logger.debug("$statement")
            doHandle(statement)
        }

    protected abstract fun CfnTemplateGenerator.doHandle(statement: T)
}
